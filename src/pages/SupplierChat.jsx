...
export default function SupplierChat() {
  ...
  const RECEIVER_ID = activeChat?.supplier_id || activeChat?.id;
  ...
  const OTHER_USER_NAME = activeChat?.name || 
                          (activeChat?.supplier_name && activeChat?.supplier_name !== "null" ? activeChat?.supplier_name : "") || 
                          (activeChat?.confirmed_supplier_name && activeChat?.confirmed_supplier_name !== "null" ? activeChat?.confirmed_supplier_name : "") || 
                          "Supplier";
  ...
  if (!activeChat) return <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "80vh", color: "#64748b", fontSize: "16px", fontWeight: "500" }}>Select chat</div>;
