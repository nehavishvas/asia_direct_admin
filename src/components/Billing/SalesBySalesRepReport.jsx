...
const SalesBySalesRepReport = () => {
    ...
    const fetchReportData = async (e) => {
        ...
        try {
            const payload = {
                ...
                sales_rep_from: salesRepFrom || null,
                sales_rep_to: salesRepTo || null,
                style: style,
            ...
            console.error("Error fetching sales by sales rep report:", error);
    ...
    const checkPermission = async () => {
        try {
            ...
            const postdata = {
                staff_id: userid,
                route_url: "/Admin/sales-by-sales-rep-report",
                user_type: usertype,
            };
            const response = await axios.post(
                    ...
                    <div className="container-fluid no-print">
                        <div className="row manageFreight">
                            <div className="col-12">
                                <h4 className="freight_hd">Sales by Sales Rep</h4>
                        ...
                        <div className="card-body">
                            <form onSubmit={fetchReportData} className="row g-2 justify-content-center align-items-end">
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-6">
                                    <label className="form-label text-secondary fw-semibold mb-1" style={{ fontSize: "12px" }}>Sales Rep</label>
                                    <div className="d-flex gap-1">
                                        <select
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-6 d-flex align-items-center justify-content-end gap-1">
                        ...
                        {loader ? (
                            ...
                            <>
                                ...
                                <div className="report-header mb-4 text-start">
                                    <h4 className="report-title mb-1 fw-bold text-dark">Sales By Sales Rep Report</h4>
                                        ...
                                        <div className="row">
                                            <div className="col-md-6">
                                                <div className="d-flex mb-1">
                                                    <span className="fw-bold text-dark me-2" style={{ minWidth: "120px" }}>Sales Rep Range:</span>
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <div className="d-flex mb-1">
                                                    ...
                                                    <span className="text-secondary" style={{ textTransform: "capitalize" }}>{style}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="table-responsive mt-4">
                                    {style === "detailed" ? (
                                        <table className="report-table">
                                            <thead>
                                                <tr className="header-top-row header-bottom-row">
                                                    ...
                                                    <th className="text-start py-2" style={{ width: "28%" }}>Customer</th>
                                                    <th className="text-end py-2" style={{ width: "8%" }}>Qty</th>
                                                    <th className="text-end py-2" style={{ width: "10%" }}>Total Cost</th>
                                                    <th className="text-end py-2" style={{ width: "12%" }}>Total Selling</th>
                                                    ...
                                                    reportData.map((repGroup, repIndex) => {
                                                        return (
                                                            <React.Fragment key={repIndex}>
                                                                {/* Sales Rep Name Header Row */}
                                                                <tr className="customer-name-row">
                                                                    <td colSpan="8" className="text-start">
                                                                        {repGroup.sales_rep || "Unknown Sales Rep"}
                                                                    </td>
                                                                </tr>
                                                                {/* Invoices List */}
                                                                {repGroup.invoices && repGroup.invoices.length > 0 ? (
                                                                    repGroup.invoices.map((inv, invIndex) => (
                                                                        <tr key={`${repIndex}-${invIndex}`} className="invoice-item-row">
                                                                            ...
                                                                            <td className="text-start">
                                                                                {inv.customer === null ? "Cash Client - ZAR" : (inv.customer || "")}
                                                                            </td>
                                                                    ...
                                                                    <tr>
                                                                        <td colSpan="8" className="text-center text-muted py-2">
                                                                            No sales records for this sales rep.
                                                                        </td>
                                                                    </tr>
                                                                )}
                                                                {/* Sales Rep Sub-total */}
                                        ...
                                        <table className="report-table">
                                            <thead>
                                                <tr className="header-top-row header-bottom-row">
                                                    <th className="text-start py-2" style={{ width: "40%" }}>Sales Rep</th>
                            ...
                            <div className="text-center py-5">
                                <p className="text-muted mb-0">Please use the filter card to search for sales by sales rep.</p>
                            </div>
                        )}
                    </div>
                </div>
...
export default SalesBySalesRepReport;
