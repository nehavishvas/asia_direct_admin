              ...
              >
                ...
                <button
                  ...
                  style={{
                    borderRadius: "24px",
                    padding: "9px 22px",
                    backgroundColor: (!message.trim() || !socketConnected) ? "#cbd5e1" : "#0b63e6",
                    borderColor: (!message.trim() || !socketConnected) ? "#cbd5e1" : "#0b63e6",
                    color: (!message.trim() || !socketConnected) ? "#94a3b8" : "#ffffff",
                    fontWeight: "600",
                    fontSize: "13.5px",
                    display: "flex",
                    alignItems: "center",
                    gap: 6,
                    cursor: (!message.trim() || !socketConnected) ? "not-allowed" : "pointer",
                    transition: "all 0.2s"
                  }}
                >
